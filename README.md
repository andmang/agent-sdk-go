<div align="center">
<img src="/docs/img/logo-header.png#gh-light-mode-only" alt="andmang" width="600">
<img src="/docs/img/logo-header-inverted.png#gh-dark-mode-only" alt="andmang" width="600">
</div>
...
```bash
go get github.com/andmang/agent-sdk-go
```
...
Download the latest release for your platform from [GitHub Releases](https://github.com/andmang/agent-sdk-go/releases) and add it to your PATH.

**Option 2: Install via Go**

```bash
go install github.com/andmang/agent-sdk-go/cmd/agent-cli@latest
```
...
git clone https://github.com/andmang/agent-sdk-go
cd agent-sdk-go
...
import (
	...
	"github.com/andmang/agent-sdk-go/pkg/config"
	...
	"github.com/andmang/agent-sdk-go/pkg/tools/websearch"
)
